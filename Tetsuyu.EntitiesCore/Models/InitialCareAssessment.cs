...
namespace Tetsuyu.EntitiesCore.Models
{
    public partial class InitialCareAssessment
    {
        public InitialCareAssessment()
        {
            ...
            InitialCareAssessmentAttachment = new HashSet<InitialCareAssessmentAttachment>();
            InitialCareAssessmentSpecialInstruction = new HashSet<InitialCareAssessmentSpecialInstruction>();
        ...
        [InverseProperty(nameof(PatientAdditionalInfo.InitialCareAssessment))]
        public virtual PatientAdditionalInfo PatientAdditionalInfoIdFkNavigation { get; set; }
        [ForeignKey(nameof(PatientMbiidFk))]
        [InverseProperty(nameof(PatientMbi.InitialCareAssessment))]
        public virtual PatientMbi PatientMbiidFkNavigation { get; set; }
        [ForeignKey(nameof(PatientMedicationIdFk))]
        [InverseProperty(nameof(PatientMedication.InitialCareAssessment))]
        public virtual PatientMedication PatientMedicationIdFkNavigation { get; set; }
        [ForeignKey(nameof(PatientMfsidFk))]
        [InverseProperty(nameof(PatientMfs.InitialCareAssessment))]
        public virtual PatientMfs PatientMfsidFkNavigation { get; set; }
        [ForeignKey(nameof(PatientNutritionIdFk))]
        [InverseProperty(nameof(PatientNutrition.InitialCareAssessment))]
        public virtual PatientNutrition PatientNutritionIdFkNavigation { get; set; }
        [ForeignKey(nameof(PatientProfileIdFk))]
        [InverseProperty(nameof(PatientProfile.InitialCareAssessment))]
        public virtual PatientProfile PatientProfileIdFkNavigation { get; set; }
        [ForeignKey(nameof(PatientRafidFk))]
        [InverseProperty(nameof(PatientRaf.InitialCareAssessment))]
        public virtual PatientRaf PatientRafidFkNavigation { get; set; }
        [ForeignKey(nameof(PatientReferralIdFk))]
        [InverseProperty(nameof(PatientReferral.InitialCareAssessment))]
        public virtual PatientReferral PatientReferralIdFkNavigation { get; set; }
        [ForeignKey(nameof(VitalSignIdFk))]
        [InverseProperty(nameof(VitalSigns.InitialCareAssessment))]
        public virtual VitalSigns VitalSignIdFkNavigation { get; set; }
        [InverseProperty("InitialCareAssessmentIdFkNavigation")]
        public virtual ICollection<IcawoundCare> IcawoundCare { get; set; }
        [InverseProperty("InitialCareAssessmentIdFkNavigation")]
        public virtual ICollection<InitialCareAssessmentAttachment> InitialCareAssessmentAttachment { get; set; }
        [InverseProperty("InitialCareAssessmentIdFkNavigation")]
        public virtual ICollection<InitialCareAssessmentSpecialInstruction> InitialCareAssessmentSpecialInstruction { get; set; }
        [InverseProperty("InitialCareAssessmentIdFkNavigation")]
