...
namespace Tetsuyu.EntitiesCore.Models
{
    public partial class CareReport
    {
        public CareReport()
        {
            ...
            InverseCareReportIdFkNavigation = new HashSet<CareReport>();
            PatientAccessLine = new HashSet<PatientAccessLine>();
        ...
        [ForeignKey(nameof(AirwayBreathingIdFk))]
        [InverseProperty(nameof(Code.CareReportAirwayBreathingIdFkNavigation))]
        public virtual Code AirwayBreathingIdFkNavigation { get; set; }
        [ForeignKey(nameof(BladderCareIdFk))]
        [InverseProperty(nameof(Code.CareReportBladderCareIdFkNavigation))]
        public virtual Code BladderCareIdFkNavigation { get; set; }
        [ForeignKey(nameof(BowelCareIdFk))]
        [InverseProperty(nameof(Code.CareReportBowelCareIdFkNavigation))]
        public virtual Code BowelCareIdFkNavigation { get; set; }
        [ForeignKey(nameof(CapillaryRefillIdFk))]
        [InverseProperty(nameof(Code.CareReportCapillaryRefillIdFkNavigation))]
        public virtual Code CapillaryRefillIdFkNavigation { get; set; }
        [ForeignKey(nameof(CarePlanIdFk))]
        [InverseProperty(nameof(CarePlan.CareReport))]
        public virtual CarePlan CarePlanIdFkNavigation { get; set; }
        [ForeignKey(nameof(CareReportIdFk))]
        [InverseProperty(nameof(CareReport.InverseCareReportIdFkNavigation))]
        public virtual CareReport CareReportIdFkNavigation { get; set; }
        [ForeignKey(nameof(CareReportRehabilitationIdFk))]
        [InverseProperty(nameof(CareReportRehabilitation.CareReport))]
        public virtual CareReportRehabilitation CareReportRehabilitationIdFkNavigation { get; set; }
        [ForeignKey(nameof(CareReportSystemInfoIdFk))]
        [InverseProperty(nameof(CareReportSystemInfo.CareReport))]
        public virtual CareReportSystemInfo CareReportSystemInfoIdFkNavigation { get; set; }
        [ForeignKey(nameof(CirculationIdFk))]
        [InverseProperty(nameof(Code.CareReportCirculationIdFkNavigation))]
        public virtual Code CirculationIdFkNavigation { get; set; }
        [ForeignKey(nameof(CoughIdFk))]
        [InverseProperty(nameof(Code.CareReportCoughIdFkNavigation))]
        public virtual Code CoughIdFkNavigation { get; set; }
        [ForeignKey(nameof(DiapersIdFk))]
        [InverseProperty(nameof(Code.CareReportDiapersIdFkNavigation))]
        public virtual Code DiapersIdFkNavigation { get; set; }
        [ForeignKey(nameof(LipsIdFk))]
        [InverseProperty(nameof(Code.CareReportLipsIdFkNavigation))]
        public virtual Code LipsIdFkNavigation { get; set; }
        [ForeignKey(nameof(LowerEyelidsIdFk))]
        [InverseProperty(nameof(Code.CareReportLowerEyelidsIdFkNavigation))]
        public virtual Code LowerEyelidsIdFkNavigation { get; set; }
        [ForeignKey(nameof(O2aidIdFk))]
        [InverseProperty(nameof(Code.CareReportO2aidIdFkNavigation))]
        public virtual Code O2aidIdFkNavigation { get; set; }
        [ForeignKey(nameof(PainDescriptionIdFk))]
        [InverseProperty(nameof(Code.CareReportPainDescriptionIdFkNavigation))]
        public virtual Code PainDescriptionIdFkNavigation { get; set; }
        [ForeignKey(nameof(PatientIdFk))]
        [InverseProperty(nameof(Patient.CareReport))]
        public virtual Patient PatientIdFkNavigation { get; set; }
        [ForeignKey(nameof(PatientNutritionIdFk))]
        [InverseProperty(nameof(PatientNutrition.CareReport))]
        public virtual PatientNutrition PatientNutritionIdFkNavigation { get; set; }
        [ForeignKey(nameof(PeripheralPulsesPedalIdFk))]
        [InverseProperty(nameof(Code.CareReportPeripheralPulsesPedalIdFkNavigation))]
        public virtual Code PeripheralPulsesPedalIdFkNavigation { get; set; }
        [ForeignKey(nameof(PeripheralPulsesRadialIdFk))]
        [InverseProperty(nameof(Code.CareReportPeripheralPulsesRadialIdFkNavigation))]
        public virtual Code PeripheralPulsesRadialIdFkNavigation { get; set; }
        [ForeignKey(nameof(SleepRestIdFk))]
        [InverseProperty(nameof(Code.CareReportSleepRestIdFkNavigation))]
        public virtual Code SleepRestIdFkNavigation { get; set; }
        [ForeignKey(nameof(TemperatureIdFk))]
        [InverseProperty(nameof(Code.CareReportTemperatureIdFkNavigation))]
        public virtual Code TemperatureIdFkNavigation { get; set; }
        [ForeignKey(nameof(VisitedByFk))]
        [InverseProperty(nameof(Users.CareReport))]
        public virtual Users VisitedByFkNavigation { get; set; }
        [ForeignKey(nameof(VitalSignIdFk))]
        [InverseProperty(nameof(VitalSigns.CareReport))]
        public virtual VitalSigns VitalSignIdFkNavigation { get; set; }
        [InverseProperty("CareReportIdFkNavigation")]
        ...
        [InverseProperty(nameof(CareReport.CareReportIdFkNavigation))]
        public virtual ICollection<CareReport> InverseCareReportIdFkNavigation { get; set; }
        [InverseProperty("CareReportIdFkNavigation")]
        public virtual ICollection<PatientAccessLine> PatientAccessLine { get; set; }
        [InverseProperty("CareReportIdFkNavigation")]
