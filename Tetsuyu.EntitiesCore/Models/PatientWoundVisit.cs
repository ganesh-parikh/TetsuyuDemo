...
namespace Tetsuyu.EntitiesCore.Models
{
    public partial class PatientWoundVisit
    {
        ...
        {
            InverseReferIdFkNavigation = new HashSet<PatientWoundVisit>();
        ...
        [ForeignKey(nameof(AssignedToIdFk))]
        [InverseProperty(nameof(Users.PatientWoundVisit))]
        public virtual Users AssignedToIdFkNavigation { get; set; }
        [ForeignKey(nameof(CareReportIdFk))]
        [InverseProperty(nameof(CareReport.PatientWoundVisit))]
        public virtual CareReport CareReportIdFkNavigation { get; set; }
        [ForeignKey(nameof(InitialCareAssessmentIdFk))]
        [InverseProperty(nameof(InitialCareAssessment.PatientWoundVisit))]
        public virtual InitialCareAssessment InitialCareAssessmentIdFkNavigation { get; set; }
        [ForeignKey(nameof(PatientWoundIdFk))]
        [InverseProperty(nameof(PatientWound.PatientWoundVisit))]
        public virtual PatientWound PatientWoundIdFkNavigation { get; set; }
        [ForeignKey(nameof(ReferIdFk))]
        [InverseProperty(nameof(PatientWoundVisit.InverseReferIdFkNavigation))]
        public virtual PatientWoundVisit ReferIdFkNavigation { get; set; }
        [ForeignKey(nameof(VitalSignIdFk))]
        [InverseProperty(nameof(VitalSigns.PatientWoundVisit))]
        public virtual VitalSigns VitalSignIdFkNavigation { get; set; }
        [InverseProperty(nameof(PatientWoundVisit.ReferIdFkNavigation))]
        public virtual ICollection<PatientWoundVisit> InverseReferIdFkNavigation { get; set; }
        [InverseProperty("PatientWoundVisitIdFkNavigation")]
